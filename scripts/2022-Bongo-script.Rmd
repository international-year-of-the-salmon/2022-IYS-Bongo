...
# Add some information on lifestages:
IYS2022_occ <- IYS2022_occ %>%
...
IYS2022_occ$lifeStage[IYS2022_occ$lifeStage == "C4/C5"] <- "C4-5"
IYS2022_occ$lifeStage[IYS2022_occ$lifeStage == "Megalopa"] <- "megalopa"
...
bongo2022_emof <- IYS2022_occ_final %>%
  select(eventID, occurrenceID, sex, lifeStage, Abundance_m3, Abundance_m2) %>%
  mutate_all(as.character) %>%
  pivot_longer(cols = sex:Abundance_m2,
  ...
  mutate(measurementID = paste(occurrenceID, measurementType, sep = "-"),
    ...
    measurementUnit = case_when(
      ...
      !measurementType %in% c("Abundance_m3", "Abundance_m2") ~ "not applicable"), 
