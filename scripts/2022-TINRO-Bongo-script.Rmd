...
# Add 'Bracts' to lifestage column for Siphonophora bracts occurrences:
shim_nw_bongo_occ$lifestage <- ifelse(grepl("BRACTS", shim_nw_bongo_occ$scientific_name), "bracts", lifestage)
...
# TODO: Confirm with Aleksei this is correct.
